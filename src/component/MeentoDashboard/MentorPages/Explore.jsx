  ...
  useEffect(() => {
    const fetchUsers = async () => {
      ...
      try {
        ...
        console.log('enter:',users.profilePicture)
      } catch (error) {
          ...
          filteredUsers.map((userData) => (
            ...
            >
              ...
              <div className="relative h-48">
                <img
                  src={userData.profilePicture?.startsWith('http') ? userData.profilePicture : `${import.meta.env.VITE_BACKEND_URL}${userData.profilePicture || '/image/default-profile.png'}`}
                  alt={userData.name}
