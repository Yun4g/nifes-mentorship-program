  ...
  return (
    <div className=' '>
      <div className='relative pb-20 '>
        ...
        <div className='absolute md:top-5 sm:top-2 top-1 w-full flex items-center justify-center text-[10px] sm:text[16px] md:text-[24px] md:px-3 px-2 sm:px-5 text-orange-50 font-bold'> 
